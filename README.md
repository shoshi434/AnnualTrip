...
> - המורות והתלמידות שנרשמות עוברות סינכרון מול מערכות בית הספר כדי לוודא שהן אכן שייכות למוסד, וכדי למנוע רישום תלמידה בתור מורה ולהפך
...
**הפעלת סימולטור ה-GPS**
> **שים לב:** יש להפעיל את הסרבר לפני הרצת הסימולטור, ולוודא שיש תלמידים ומורים רשומים במסד הנתונים.
